...
1. Display a list of albums fetched from the API: (https://jsonplaceholder.typicode.com/albums)
...
3. When a user taps on an album, show a system loading indicator and then display a list of photos from that album (e.g.,https://placehold.co)
4. When a user taps on a photo, open it in full-screen mode with pinch-to-zoom enabled
----------------------------------------------------------------------------------------------------------
RESULT:
